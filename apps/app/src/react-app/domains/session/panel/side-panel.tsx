...
The artifact preview keeps **outside-chat Markdown** readable with inline \`surface renderer\`, a fenced code block, and [AgencyAI](https://github.com/artreimus/AgencyAI).
