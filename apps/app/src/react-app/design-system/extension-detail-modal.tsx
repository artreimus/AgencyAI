...
const kindDesc: Record<ExtensionKind, string> = {
  ...
  plugin: "Extends AgencyAI with additional capabilities managed by your organization.",
  skill: "A reusable workflow that your agent can execute on demand.",
  "ui-control": "Lets another MCP client inspect and drive this AgencyAI desktop UI through a local stdio wrapper.",
  extension: "An AgencyAI extension that adds tools, providers, or integrations to your workspace.",
};
